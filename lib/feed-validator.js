...
export async function checkFeedUrl(url, options = {}) {
  ...
  try {
    ...
    if (feedData.itemCount === 0) {
      return { type, itemCount: 0, title: feedData.title, ...redirectInfo };
    }
    ...
    return { type, itemCount: feedData.itemCount, title: feedData.title, lastItemDate: feedData.lastItemDate, ...redirectInfo };
